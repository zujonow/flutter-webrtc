...
// //  * Display the video stream on a Surface.
// //  * renderFrame() is asynchronous to avoid blocking the calling thread.
// //  * This class is thread safe and handles access from potentially three different
// //  * threads:
// //  * Interaction from the main app in init, release and setMirror.
// //  * Interaction from C++ rtc::VideoSinkInterface in renderFrame.
// //  * Interaction from SurfaceHolder lifecycle in surfaceCreated, surfaceChanged,
// //  * and surfaceDestroyed.
// //  */
// // public class SurfaceTextureRenderer extends EglRenderer {
// //   // Callback for reporting renderer events. Read-only after initilization so no
// //   // lock required.
// //   private RendererCommon.RendererEvents rendererEvents;
// //   private final Object layoutLock = new Object();
// //   private boolean isRenderingPaused;
...
// //    * |drawer| will be used
// //    * for drawing frames on the EGLSurface. This class is responsible for calling
// //    * release() on
// //    * |drawer|. It is allowed to call init() to reinitialize the renderer after a
// //    * previous
// //    * init()/release() cycle.
// //    */
// //   public void init(final EglBase.Context sharedContext,
...
// //    *            Float.POSITIVE_INFINITY to disable fps
// //    *            reduction.
// //    */
// //   @Override
// //   public void setFpsReduction(float fps) {
