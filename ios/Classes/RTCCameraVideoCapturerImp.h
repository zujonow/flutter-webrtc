...
@interface RTCCameraVideoCapturerImp : RTCVideoCapturer
...
@property(nonatomic, assign) BOOL createImage;

@property(nonatomic, assign) float captureImageHeight;

@property(nonatomic, assign) float captureImageWidth;
